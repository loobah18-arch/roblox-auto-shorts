# ðŸ¤– Automated Roblox Shorts Engine
...
## ðŸš€ Architecture & Core Features

```
[GitHub Actions Run]
       â”‚
       â”œâ”€â”€â–º State Manager (Rotate Game & Load Memory)
       â”‚
       â”œâ”€â”€â–º Groq API (Script Generation & Scene Prompts)
       â”‚
       â”œâ”€â”€â–º Pollinations AI (8x Unreal Engine 5 Renders)
       â”‚
       â”œâ”€â”€â–º Edge-TTS (Raw Voiceover Generation)
       â”‚
       â”œâ”€â”€â–º FFmpeg Audio Filter (Trim Silence, Speed to 1.15x, Raise Pitch)
       â”‚
       â”œâ”€â”€â–º Subtitle Engine (Generate Word-Level Karaoke ASS Style)
       â”‚
       â”œâ”€â”€â–º FFmpeg Video Filter (Burn Subtitles & Mix Background BGM)
       â”‚
       â””â”€â”€â–º YouTube Data API v3 (Automatic Video Upload)
```
...
To maintain narrative continuity across daily uploads, the engine writes back an episodic **story memory** text file for each game, ensuring that tomorrowâ€™s generation starts exactly where today's cliffhanger ended.
...
## ðŸ› ï¸ GitHub Repository Directory Layout
...
â”œâ”€â”€ .github/
â”‚   â””â”€â”€ workflows/
â”‚       â””â”€â”€ upload.yml          # The schedule runner configuration
â”œâ”€â”€ bgm/
â”‚   â””â”€â”€ track1.mp3              # Place any background .mp3 tracks here
â”œâ”€â”€ .gitignore                  # Media-safe exclusions file
â”œâ”€â”€ character_bible.json        # Global fallback character settings
â”œâ”€â”€ character_bible_adopt_me.json
â”œâ”€â”€ character_bible_blox_fruits.json
â”œâ”€â”€ game_state.json             # Stores active rotation index and run count
â”œâ”€â”€ main.py                     # The main automation script
â””â”€â”€ requirements.txt            # Python environment packages
```

---

## ðŸš€ Step-by-Step Local & Production Workflow
...
## ðŸ“‹ The Automated Workflow (`upload.yml`)
...
## ðŸ› ï¸ Self-Healing & Fallback Configurations
